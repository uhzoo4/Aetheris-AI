    ...
    <section className="py-32 px-container-padding">
      <div className="max-w-7xl mx-auto rounded-3xl overflow-hidden relative p-16 md:p-24 bg-nocturnal-expedition flex flex-col items-center text-center border border-mystic-mint/10 shadow-[0_20px_50px_-20px_rgba(17,76,90,0.5)]">
        <div className="absolute inset-0 z-0">
          <div className="absolute -top-1/2 -right-1/4 w-[600px] h-[600px] ambient-glow rounded-full"></div>
        </div>
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-deep-saffron text-oceanic-noir px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform">Get Started Now</Button>
            <Button className="border border-mystic-mint/30 text-arctic-powder px-10 py-4 rounded-full font-medium hover:bg-oceanic-noir/50 transition-colors">Request a Demo</Button>
          </div>
        </div>
      </div>
    </section>

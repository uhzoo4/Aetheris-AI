      ...
      <div className="max-w-7xl mx-auto rounded-3xl overflow-hidden relative p-16 md:p-24 bg-nocturnal-expedition flex flex-col items-center text-center border border-mystic-mint/10 shadow-[0_20px_50px_-20px_rgba(17,76,90,0.5)]">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ref={primaryRef} 
              onClick={() => openModal('System Initiation', 'Establishing connection to Aetheris node network... Complete onboarding instructions have been dispatched.')}
            ...
            <Button 
              ref={secondaryRef} 
              onClick={() => openModal('Demonstration Booking', 'Scheduling enterprise walkthrough. Our solution engineers will reach out to confirm your virtual sandbox environment.')}
